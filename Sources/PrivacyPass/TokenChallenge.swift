...
public struct TokenChallenge: Equatable, Sendable {
    ...
    public static let minSizeInBytes =
        MemoryLayout<UInt16>.size + MemoryLayout<UInt16>.size
        + MemoryLayout<UInt8>
    ...
    public init<C: Collection<UInt8>>(from bytes: C) throws {
        ...
        let originInfoCount = try UInt16(
            bigEndianBytes: extractBytes(count: MemoryLayout<UInt16>.size)
        )
    ...
    public func bytes() throws -> [UInt8] {
        ...
        var bytes: [UInt8] = []
        let size =
            Self.minSizeInBytes + issuerAscii.count + redemptionContext.count
            + originInfoAscii.count
